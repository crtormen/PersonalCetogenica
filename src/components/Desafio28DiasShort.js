...
import BonusShort from './BonusShort';
...
const Desafio28DiasShort = () => (
    <Desafio28DiasSection>
        <MetodoIntro>
            ...
            <C.Block>
                <C.Paragraph>O Desafio de 28 Dias do Método Esbelta é um Método de Emagrecimento 100% Online, 
                que irá destravar rapidamente o seu emagrecimento, e te ajudar a eliminar de 5 a 10Kg em apenas 28 dias, além de melhorar sua saúde, regular seus hormônios, acelerar seu metabolismo, e aumentar sua saciedade.</C.Paragraph>
        ...
        <MetodoBonus>
            <C.Title><C.BG>E Ainda Ganhará Presentes Incríveis</C.BG></C.Title>
            <C.SubTitle>Ao se inscrever hoje no Desafio de 28 Dias do Método Esbelta, você receberá:</C.SubTitle>
            <C.Block>
                <BonusShort />
            </C.Block>
        </MetodoBonus>
...
export default Desafio28DiasShort;